...
#include <asm/tlbflush.h>		// Sangjin Luma
#include <asm/tlb.h>			// Sangjin Luma // Arch specific: arch/x86/include/asm/tlb.h
//#include <arch/x86/include/asm/tlb.h>			// Sangjin Luma // Arch specific: arch/x86/include/asm/tlb.h
//#include <asm-generic/tlb.h>			// Sangjin Luma // This for common TLB
//#include <asm/ldt.h>	// Sangjin Luma
//#include <asm/desc.h>	// Sangjin Luma
//#include <asm/mmu_context.h>	// Sangjin Luma
//#include "../../mm/internal.h"		// Sangjin Luma
//#include "../../fs/internal.h"		// Sangjin Luma
...
static int nova_set_vma_read(struct vm_area_struct *vma)
{
	...
	struct mmu_gather tlb;		// Sangjin Luma
	...
	tlb_gather_mmu(&tlb, mm);					// Sangjin Luma
	//change_protection(vma, vma->vm_start, vma->vm_end,
	//			new_page_prot, MM_CP_UFFD_WP_ALL);
	change_protection(&tlb, vma, vma->vm_start, vma->vm_end, MM_CP_UFFD_WP_ALL); // Sangjin Luma
	tlb_finish_mmu(&tlb);						// Sangjin Luma
