...
static int nova_seq_timing_open(struct inode *inode, struct file *file)
{
	...
	return single_open(file, nova_seq_timing_show, pde_data(inode));	// Sangjin Luma
}
	...
	size_t len, loff_t *ppos)
{
	...
	struct super_block *sb = pde_data(inode);		// Sangjin Luma
...
static int nova_seq_IO_open(struct inode *inode, struct file *file)
{
	...
	return single_open(file, nova_seq_IO_show, pde_data(inode));		// Sangjin Luma
}
...
static int nova_seq_test_perf_open(struct inode *inode, struct file *file)
{
	...
	return single_open(file, nova_seq_test_perf_show, pde_data(inode));	// Sangjin Luma
}
...
static int nova_seq_gc_open(struct inode *inode, struct file *file)
{
	...
	return single_open(file, nova_seq_gc_show, pde_data(inode));		// Sangjin Luma
}
