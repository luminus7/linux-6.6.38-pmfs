...
EXPORT_SYMBOL(do_sys_ftruncate);	// Sangjin Luma
...
//		int, flags)
int faccessat2_internal(int dfd, const char __user * filename, int mode, int flags)
{
	return do_faccessat(dfd, filename, mode, flags);
}
EXPORT_SYMBOL(faccessat2_internal);	// Sangjin Luma

SYSCALL_DEFINE4(faccessat2, int, dfd, const char __user *, filename, int, mode,
		int, flags)
{
	return faccessat2_internal(dfd, filename, mode, flags);
}

//SYSCALL_DEFINE2(access, const char __user *, filename, int, mode)
int access_internal(const char __user * filename, int mode)
{
	return do_faccessat(AT_FDCWD, filename, mode, 0);
}
EXPORT_SYMBOL(access_internal);		// Sangjin Luma

SYSCALL_DEFINE2(access, const char __user *, filename, int, mode)
{
	return access_internal(filename, mode);
}
...
EXPORT_SYMBOL(file_open_name);	// Sangjin Luma
...
int close_internal(unsigned int fd)		// Sangjin Luma
{
	int retval;
	struct file *file;
...
EXPORT_SYMBOL(close_internal);		// Sangjin Luma
