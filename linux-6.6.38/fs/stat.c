...
//		char __user *, buf, int, bufsiz)
ssize_t readlinkat_internal(int dfd, const char __user * pathname, char __user * buf, int bufsiz)
{
	return do_readlinkat(dfd, pathname, buf, bufsiz);
}
EXPORT_SYMBOL(readlinkat_internal);	// Sangjin Luma

SYSCALL_DEFINE4(readlinkat, int, dfd, const char __user *, pathname,
		char __user *, buf, int, bufsiz)
{
	return readlinkat_internal(dfd, pathname, buf, bufsiz);
}
