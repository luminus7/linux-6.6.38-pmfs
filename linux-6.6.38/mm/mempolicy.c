...
EXPORT_SYMBOL(do_set_mempolicy);	// Sangjin Luma
...
inline int sanitize_mpol_flags(int *mode, unsigned short *flags)	// Sangjin Luma
{
...
EXPORT_SYMBOL(sanitize_mpol_flags);	// Sangjin Luma
...
//long kernel_set_mempolicy(int mode, const unsigned long __user *nmask,
				 unsigned long maxnode)
{
	unsigned short mode_flags;
	nodemask_t nodes;
...
//EXPORT_SYMBOL(kernel_set_mempolicy);	// Sangjin Luma
