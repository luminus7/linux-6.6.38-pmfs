...
//	set_nlink(inode, le16_to_cpu(pi->i_links_count));
	...
	inode_set_ctime(inode, (__s32)le32_to_cpu(pi->i_ctime), 0);	// Sangjin Luma
...
int nova_getattr(struct mnt_idmap *idmap, const struct path *path,	// Sangjin Luma
		 struct kstat *stat, u32 request_mask, unsigned int query_flags)
{
...
//		       struct iattr *attr)
int nova_notify_change(struct mnt_idmap *idmap, struct dentry *dentry,		// Sangjin Luma
		       struct iattr *attr)
{
